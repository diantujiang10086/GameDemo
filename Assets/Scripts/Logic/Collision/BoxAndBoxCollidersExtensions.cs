...
public static class BoxAndBoxCollidersExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Overlap(BoxGeometry boxGeometryA, BoxGeometry boxGeometryB)
    {
        CalculateBoxCorners(boxGeometryA, out var aCorner0, out var aCorner1, out var aCorner2, out var aCorner3);
        CalculateBoxCorners(boxGeometryB, out var bCorner0, out var bCorner1, out var bCorner2, out var bCorner3);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void CalculateBoxCorners(in BoxGeometry boxGeometry, out float2 corner0, out float2 corner1, out float2 corner2, out float2 corner3)
    {
        float2 pos = boxGeometry.center;
        ...
        corner0 = pos - rightOffset - upOffset; 
        corner1 = pos + rightOffset - upOffset; 
        corner2 = pos + rightOffset + upOffset; 
        corner3 = pos - rightOffset + upOffset; 
    }
}
